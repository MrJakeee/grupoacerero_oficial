...
@section("contenedor")
    ...
    <div class="table_container table-responsive p-4 m-2" style="max-height: 100vh; overflow-y: auto; height: 76.5vh">
        <table class="table table-hover text-center">
            <h1 class="text-center">Empleados</h1>
            <div class="text-center p-5">
                <form action="" >
                    <a href="" data-bs-toggle="modal" data-bs-target="#modalAgregar" class="btn-custom bg-orange clear_a">AgregarEmpleado</a>
                </form>
            </div>
                ...
                <div class="modal fade" id="modalAgregar" tabindex="-1" aria-labelledby="AgregarEmpleados" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route("empleados.add")}}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="nombre" class="form-label">Nombre empleado</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="domicilio" class="form-label">Domicilio</label>
                                        <input type="text" class="form-control" name="domiclio_empleado"  >
                                    </div>
                                    <div class="mb-3">
                                        <label for="colonia" class="form-label">Colonia</label>
                                        <input type="text" class="form-control" name="colonia_empleado" >
                                    </div>
                                    <div class="mb-3">
                                        <label for="cargo" class="form-label">Cargo</label>
                                        <select class="form-control" name="cargo_empleado">
